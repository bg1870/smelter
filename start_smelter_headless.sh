...
./target/release/main_process --web-renderer-chromium-extra-args="--disable-gpu --disable-gpu-compositing --no-sandbox --disable-dev-shm-usage --disable-setuid-sandbox"
